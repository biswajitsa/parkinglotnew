...
export class AppComponent implements OnInit{
  ...
  parkNewvehicle() {
    this.http.post<ParkingLot>(this.server_url, JSON.stringify(this.newParking), 
  ...
  getAllParking() {
    ...
    this.error_message = '';
    this.http.get<ParkingLot[]>(this.server_url).subscribe( data => 
      { this.parkings = data; }, error => { 
        this.error_message = error; 
      });
  }
  ...
  calculateAmount(event) {
    ...
    this.vehicleForm.patchValue({parkingAmount:Math.trunc(amount)});
  }
